...
import MenuMessaggi from "../components/MenuMessaggi";
import styles from "./Messaggi.module.css";

const Messaggi: FunctionComponent = () => {
  return (
    <div className={styles.messaggi}>
      <div className={styles.messaggiChild} />
      ...
      <b className={styles.messaggi1}>Messaggi</b>
      ...
      <div className={styles.vectorParent}>
        ...
        <img className={styles.frameItem} alt="" src="/polygon-2.svg" />
        ...
        <div className={styles.loremIpsumDolor1}>
          Lorem ipsum dolor sit amet, lorerum...
        </div>
        <div className={styles.loremIpsumDolor2}>
          Lorem ipsum dolor sit amet, lorerum...
        </div>
        <div className={styles.cristina}>Cristina</div>
        <div className={styles.benedetta}>Benedetta</div>
        ...
        />
        <img
          className={styles.vinceFlemingJ3lfJn6deoUnspIcon}
          alt=""
          src="/vinceflemingj3lfjn6deounsplash-2@2x.png"
        />
        <img
          className={styles.vinceFlemingJ3lfJn6deoUnspIcon1}
          alt=""
          src="/vinceflemingj3lfjn6deounsplash-2@2x.png"
        />
        ...
        <div className={styles.mariano}>Mariano</div>
        <img
          className={styles.vinceFlemingJ3lfJn6deoUnspIcon2}
          alt=""
          src="/vinceflemingj3lfjn6deounsplash-2@2x.png"
        />
        ...
        <div className={styles.enea}>Enea</div>
        <img
          className={styles.vinceFlemingJ3lfJn6deoUnspIcon3}
          alt=""
          src="/vinceflemingj3lfjn6deounsplash-6@2x.png"
        />
        <img
          className={styles.vinceFlemingJ3lfJn6deoUnspIcon4}
          alt=""
          src="/vinceflemingj3lfjn6deounsplash-2@2x.png"
        />
        ...
        <div className={styles.mattia}>Mattia</div>
        <div className={styles.benedetta1}>Benedetta</div>
        <img
          className={styles.shannonVandenheuvelZ9p4m58hdIcon}
          alt=""
          src="/shannonvandenheuvelz9p4m58hdyounsplash-1@2x.png"
        />
        <img
          className={styles.jakeNackosIf9tk5uyKiUnsplaIcon}
          alt=""
          src="/jakenackosif9tk5uykiunsplash-1@2x.png"
        />
        <img
          className={styles.jakeNackosIf9tk5uyKiUnsplaIcon1}
          alt=""
          src="/jakenackosif9tk5uykiunsplash-1@2x.png"
        />
        <img
          className={styles.austinWadeX6uj51n5ce8UnsplaIcon}
          alt=""
          src="/austinwadex6uj51n5ce8unsplash-2@2x.png"
        />
        <div className={styles.loremIpsumDolor5}>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
          eiusmod tempor incididunt ut labore et dolore magna aliqua. Turpis
          massa tincidunt dui ut ornare. Sagittis id consectetur purus ut
          faucibus pulvinar elementum. Auctor augue mauris augue neque.
        </div>
        <div className={styles.loremIpsumDolor6}>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
          eiusmod tempor incididunt ut labore et dolore magna aliqua. Turpis
          massa tincidunt dui ut ornare. Sagittis id consectetur purus ut
          faucibus pulvinar elementum. Auctor augue mauris.
        </div>
        <div
          className={styles.loremIpsumDolor7}
        >{`Lorem ipsum dolor sit amet, consectetur adipiscing `}</div>
        <div className={styles.pm}>2:01 PM</div>
        <div className={styles.pm1}>3:36 PM</div>
        <div className={styles.pm2}>2:01 PM</div>
        <div className={styles.iniziaADigitare}>Inizia a digitare...</div>
      </div>
      <LogoutButton
      ...
      <MenuMessaggi
        ...
        menuMessaggiPosition="absolute"
        menuMessaggiTop="193.5px"
        menuMessaggiLeft="64px"
      />
    </div>
  );
};
